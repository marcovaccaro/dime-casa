<?php
/**
 * Template name: Portfolio - 4 columns without sidebar
 *
 */
				...
				<div class="one_fourth<?php if($i % 4 == 0) echo ' last'; ?>">
					<div class="portfolio-item" id="post-<?php the_ID(); ?>">
						...
						if (has_post_thumbnail()) {
							...
							$img_shortcode = '[image align="none" href="'.get_permalink().'" title="'.the_title_attribute('echo=0').'" width="258"';
