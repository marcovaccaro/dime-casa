...
this.options.speed,this.options.easing),this.$sliderElem.stop().animate({left:this.$thumbs.eq(a).position().left},this.options.speed)).done(function(){b.css("opacity",0).find("div.ei-title > *").css("opacity",0);d.current=a;d.isAnimating=false})},_initEvents:function(){var a=this;c(i).on("smartresize.eislideshow",function(){a._setImagesSize();a.$sliderElem.css("left",a.$thumbs.eq(a.current).position().left)});this.$thumbs.on("click.eislideshow",function(){a.options.autoplay&&(clearTimeout(a.slideshow),
